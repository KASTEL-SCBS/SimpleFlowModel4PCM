 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.composition.securityanalyses.basic.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
	...
	protected EClass eStaticClass() {
		return BasicPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
