 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.composition.securityanalyses.basic.impl.IdentifiedElementImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdentifiedElementImpl extends MinimalEObjectImpl.Container implements IdentifiedElement {
	...
	protected EClass eStaticClass() {
		return BasicPackage.Literals.IDENTIFIED_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.IDENTIFIED_ELEMENT__ID, oldId, id));
	}
